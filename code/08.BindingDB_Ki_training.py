...
def main():
    ...
    # Load Ki data
    ##############
    Ki_training_data = pd.read_csv(f"{config['Path']['Ki_df']}", sep = '\t')
    Uniprot_IDs, Lig_codes, BA_labels = Ki_training_data.iloc[:, 0].values, Ki_training_data.iloc[:, 1].values, np.round(Ki_training_data.iloc[:, 2].values, 4)
    ...
    print(f"[Ki] - random split case training...")
    for idx in range(3):
        ...
        for epoch in range(1, config["Train"]["epochs"] + 1):
            ...
            save_path = f"{config['Path']['Ki_save_path']}/random_split/CV{idx}/BlendNet_S.pth"
    ...
    print(f"[Ki] - new protein case training...")
    for idx in range(3):
        reset_seed(config['Train']['seed'])
        ...
        for epoch in range(1, config["Train"]["epochs"] + 1):
            ...
            save_path = f"{config['Path']['Ki_save_path']}/new_protein/CV{idx}/BlendNet_S.pth"
            ValLoss, patience = trainer.eval(ValLoader, idx, save_path = save_path, max_teacher_error = max_validation_teacher_error, min_teacher_error = min_validation_teacher_error)
            print(f"[Val ({epoch})] ToTal BA loss: {ValLoss['Total_BALoss']:.4f}, BA loss: {ValLoss['BALoss']:.4f}, Imitation loss: {ValLoss['ImitationLoss']:.4f}")
    ...
    print(f"[Ki] - new compound case training...")
    for idx in range(3):
        reset_seed(config['Train']['seed'])
        ...
        for epoch in range(1, config["Train"]["epochs"] + 1):
            ...
            save_path = f"{config['Path']['Ki_save_path']}/new_compound/CV{idx}/BlendNet_S.pth"
            ValLoss, patience = trainer.eval(ValLoader, idx, save_path = save_path, max_teacher_error = max_validation_teacher_error, min_teacher_error = min_validation_teacher_error)
            print(f"[Val ({epoch})] ToTal BA loss: {ValLoss['Total_BALoss']:.4f}, BA loss: {ValLoss['BALoss']:.4f}, Imitation loss: {ValLoss['ImitationLoss']:.4f}")
    ...
    print(f"[Ki] - blind split case training...")
    for idx in range(3):
        reset_seed(config['Train']['seed'])
        ...
        for epoch in range(1, config["Train"]["epochs"] + 1):
            ...
            save_path = f"{config['Path']['Ki_save_path']}/blind_split/CV{idx}/BlendNet_S.pth"
            ValLoss, patience = trainer.eval(ValLoader, idx, save_path = save_path, max_teacher_error = max_validation_teacher_error, min_teacher_error = min_validation_teacher_error)
            print(f"[Val ({epoch})] ToTal BA loss: {ValLoss['Total_BALoss']:.4f}, BA loss: {ValLoss['BALoss']:.4f}, Imitation loss: {ValLoss['ImitationLoss']:.4f}")
