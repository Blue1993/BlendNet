...
from modules.compound_modules.models import VectorQuantizer
from modules.compound_modules.trainers import PreTrainCompound
from modules.compound_modules.lr_schedulers import WarmUpWrapper
from modules.compound_modules.loaders import MoleculeGraphDataset, contrastive_collate
...
def main():
    ...
    config_path = "pretraining_compound_encoder.yml"
    ...
    checkpoint = torch.load(config['MGraphPaths']['VQVAE_path'])
