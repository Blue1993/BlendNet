...
from .base_layers import BertCrossattLayer, BertIntermediate, BertOutput 
...
class Pseq2Sites(nn.Module):
    def __init__(self, config):
        ...
        # Query Embedding
        self.position_embeddings = nn.Embedding(config["Architecture"]["max_lengths"], 1024) 
    ...
    def forward(self, prots, total_prots_data, attention_mask, position_ids):
        ...
        # query features
        query_embeddings = prot_feats + protein_position_embeddings 
